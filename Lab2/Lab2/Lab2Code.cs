namespace Lab2
{
    ...
    public class Lab2Code
    {
        ...
        public static void SetValue(List<int> min, int index, int value)
        {
            index += min.Count >> 1;
            min[index] = value;
            while (index > 0)
        ...
        public static int GetRangeMin(List<int> min, int left, int right)
        {
            int answer = INF;
            left += min.Count >> 1;
            right += min.Count >> 1;
        ...
        {
            string inputFilename = @"C:\\Users\\Admin\\source\\repos\\CrossLabs\\Lab2\\Lab2\\Input.txt";
            string outputFilename = @"C:\\Users\\Admin\\source\\repos\\CrossLabs\\Lab2\\Lab2\\Output.txt";
